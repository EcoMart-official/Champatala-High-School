          ...
          <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
            {allImages.map((img, i) => (
              <motion.div
                ...
                className="relative rounded-2xl overflow-hidden group cursor-pointer break-inside-avoid shadow-sm hover:shadow-xl transition-all duration-300"
                onClick={() => setSelectedImage(img)}
              >
                <img src={img} alt={`Gallery App ${i}`} className="w-full h-auto object-cover group-hover:scale-105 transition-transform duration-700" loading="lazy" />
